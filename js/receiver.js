...
playerManager.setMessageInterceptor(
  ...
  (request) => {
    ...
    request.media.contentId = TEST_CONTENT_ID;
    // }
      ...
      makeRequest("GET", SAMPLE_URL).then(function (data) {
        ...
        if (!item) {
          ...
          // Configure player to parse HLS content
            ...
            // vastTemplate.adTagUrl = `https://pubads.g.doubleclick.net/gampad/ads?iu=/21775744923/external/vmap_ad_samples&sz=640x480&cust_params=sample_ar%3Dpremidpostoptimizedpod&ciu_szs=300x250&gdfp_req=1&ad_rule=1&output=vmap&unviewed_position_start=1&env=vp&impl=s&cmsid=496&vid=short_onecue&correlator=${cacheBuster}`;
